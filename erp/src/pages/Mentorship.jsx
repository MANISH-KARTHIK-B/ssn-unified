    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="rounded-2xl border border-wine-100 bg-white p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <a href={`${HUB_URL}/mentors`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 rounded-lg bg-wine-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-wine-700">
          ...
          {appointments.map((a) => (
            <div key={a.id} className="flex items-center justify-between rounded-xl border border-stone-100 p-3">
              <div>
                ...
                {a.reply && <p className="mt-1 text-xs text-stone-500">reply: {a.reply}</p>}
              </div>
