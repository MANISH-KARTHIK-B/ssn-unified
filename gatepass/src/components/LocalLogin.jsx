  ...
  return (
    <div className="grid min-h-screen place-items-center bg-brand-900 px-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-xl">
        <p className="font-display text-2xl font-bold text-brand-700">SSN Gatepass</p>
        ...
        <form onSubmit={onSubmit} className="space-y-3">
          ...
          <button className="w-full rounded-lg bg-brand-500 py-2.5 text-sm font-semibold text-white hover:bg-brand-600">
            Sign in
          </button>
        </form>
        <a href={HUB_URL} className="mt-4 block text-center text-xs text-brand-600 hover:underline">
