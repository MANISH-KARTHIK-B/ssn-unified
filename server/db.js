...
function buildLibraryCatalog() {
  return [
    { id: "b1", title: "Principles of Digital Electronics", author: "R. Menon", genre: "Electronics", available: true, copies: 3 },
    { id: "b2", title: "Signals, Systems and Transforms", author: "A. Krishnan", genre: "Electronics", available: true, copies: 2 },
    { id: "b3", title: "Data Structures with Object Orientation", author: "S. Iyer", genre: "Computer Science", available: false, copies: 0 },
    { id: "b4", title: "Introduction to Operating Systems", author: "P. Raghavan", genre: "Computer Science", available: true, copies: 5 },
    { id: "b5", title: "Engineering Thermodynamics", author: "V. Subramaniam", genre: "Mechanical", available: true, copies: 1 },
    { id: "b6", title: "Circuit Theory and Networks", author: "K. Bala", genre: "Electronics", available: true, copies: 4 },
    { id: "b7", title: "Database Management Systems", author: "N. Sarangan", genre: "Computer Science", available: true, copies: 3 },
    { id: "b8", title: "Computer Networks", author: "T. Anandh", genre: "Computer Science", available: true, copies: 2 },
    { id: "b9", title: "Machine Learning Foundations", author: "R. Deepa", genre: "Computer Science", available: false, copies: 0 },
    { id: "b10", title: "Algorithms Design and Analysis", author: "M. Vignesh", genre: "Computer Science", available: true, copies: 4 },
    { id: "b11", title: "Microprocessors and Microcontrollers", author: "S. Chandran", genre: "Electronics", available: true, copies: 2 },
    { id: "b12", title: "Software Engineering Practices", author: "L. Priya", genre: "Computer Science", available: true, copies: 6 },
    { id: "b13", title: "Fluid Mechanics and Machinery", author: "G. Nataraj", genre: "Mechanical", available: true, copies: 2 },
    { id: "b14", title: "Strength of Materials", author: "R. Elango", genre: "Mechanical", available: false, copies: 0 },
    { id: "b15", title: "Power Electronics and Drives", author: "J. Meenakshi", genre: "Electronics", available: true, copies: 3 },
    { id: "b16", title: "Structural Analysis", author: "D. Kumaresan", genre: "Civil", available: true, copies: 2 },
    { id: "b17", title: "Surveying and Geomatics", author: "P. Bhuvaneswari", genre: "Civil", available: true, copies: 1 },
    { id: "b18", title: "Engineering Mathematics III", author: "S. Radhakrishnan", genre: "Mathematics", available: true, copies: 7 },
    { id: "b19", title: "Probability and Statistics for Engineers", author: "A. Lakshmi", genre: "Mathematics", available: true, copies: 5 },
    { id: "b20", title: "Compiler Design", author: "K. Ilamparithi", genre: "Computer Science", available: true, copies: 2 }
  ];
}
...
export async function initDb() {
  ...
  if (!db.data || !db.data.users) {
    ...
    db.data = {
      ...
      library: { catalog: buildLibraryCatalog(), issued: students.flatMap((s) => buildIssuedBooks(s.id)), reservations: [] },
